 ...
 * @returns {{ list: Function, unreadCount: Function, markRead: Function, markUnread: Function, markAllRead: Function, remove: Function, removeAll: Function }} The adapter `NotificationsItem`, `NotificationsModal` and `InboxPage` read
 */
export const createNotificationsClient = ({ client }) => ({
  ...
  markUnread: id => client.post(`${INBOX}${encodePath(id)}/unread`),
