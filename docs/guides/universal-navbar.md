...
| `src/components/common/`                                                       | `Avatar.jsx`, `BrandLogo.jsx` (the `status.brand.logo_url` mark and its dark variant), `ErrorBoundary.jsx`, `NotAvailableStub.jsx`, `ConfirmModal.jsx`, `PageHeader.jsx` and the other pieces every feature draws                                                                                                                                |
...
| `public/brand/`                                                                | The brand marks a UI backend may name in `brand.logo_url` when it does not serve its own                                                                                                                                                                                                                                                         |
