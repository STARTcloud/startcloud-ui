...
[Universal Pages Contract](universal-pages/)). Signed out the cluster
reads, left to right, Discover, the ticket icon, the language control,
the theme button, then the Sign in button of the Account row, each
present only by its own condition; signed in it reads search, Discover,
theme, language, account.

| Slot     | Signed out                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Signed in                                                                                                                                                                                                                                                                                                                                                                                                      |
| -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Search   | absent, because app-wide search needs a session and no signed-out page binds the navbar search                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | first in the cluster, only while the page has registered a search or the app can be searched as a whole: magnifier icon that expands into the search input (see Search and filters)                                                                                                                                                                                                                            |
| Discover | a text link, "Discover", an in-router link to `/organizations/discover` while the UI backend advertises `discover`; absent otherwise                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | a compass glyph (`FaCompass`) titled "Discover", the same in-router link, drawn right after the search control while `discover` is advertised                                                                                                                                                                                                                                                                  |
| Help     | a ticket glyph (`FaTicket`) titled "Help": the improvement-request ticket URL opened in a new tab, built from `ticket.baseUrl` with `req` from `ticket.reqType`, `customerId` from `ticket.fallbackCustomerId` and `context`, and no `user` or `email`, because the customer id of the whole app rides the status payload so an anonymous visitor on the sign-in, recovery or error pages can report a fault against the site's customer, a six-character hex code Prominic identifies its customers by; drawn only while the app holds a ticket system, `ticket` in the status payload or the `ticket_system` of `/api/config/ticket`, and `links.docs` and `links.contact` draw nowhere in the cluster | hidden; the Help row of the user menu is the same ticket URL with the person's customer id, name and email added, and `links.docs` and `links.contact` are the Docs and Contact rows of the app section                                                                                                                                                                                                        |
...
| Theme    | icon button, cycles auto → light → dark, the last control in the cluster                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | same, drawn between search and language; writes through `PATCH /api/user/preferences`                                                                                                                                                                                                                                                                                                                          |
| Account  | primary **Sign in** button after the theme button; it always carries the page it was pressed on as the return path, the ended session's page while the session-ended banner shows, never an auth page; hidden while the route is an auth path, on every host, where the page itself is the sign-in                                                                                                                                                                                                                                                                                                                                                                                                       | user's name + avatar as one toggle; clicking either opens the menu; the account button carries the unread count on its top right, the same number the menu's Notifications row shows, hidden at zero, from the notifications feature's one context, in the sidebar Inbox badge's look, because the avatar is the one control on every page and a person must see that something waits without opening the menu |
...
- Nothing sits left of the cluster but the brand while signed out, and
  nothing but the brand and the breadcrumb signed in: `links.docs` and
  `links.contact` are rows of the app-named menu section signed in and
  draw nowhere while signed out, the ticket icon being the one help a
  signed-out page carries and Discover its one destination, and About is
  a menu row alone, because a signed-out page is a sign-in page or a
  public listing and every link on it that is not the brand is help or
  the directory.
...
- **Registration**: a page publishes a binding — the query and its
  ...
  own, per page in local storage under `table_prefs_<org or home>`, the
  same key on every UI backend because storage is per origin.
...
- **Export.** A feature exports a `sidebar` function,
  ...
  `sidebar(account, collections)` for the catalog feature, which
  branches on nothing the host advertises and draws for every visitor of
  a host mounting a collection, answering
  ...
  mounted feature's answer in the order catalog, profile, identity (on a
  `cookie` host), vdi, then the shared admin feature (on every other
  host), the mounted collection definitions handed in for the catalog's
  Browse tree, and hands the list to `AppShell` as `sidebar`, and
  ...
  `{ key, icon?, label, to?, children?, status?, matches? }`, `to` absent
...
| `links`           | `docs` and `contact`: the Docs and Contact rows of the app section signed in, each absent while empty; neither draws in the signed-out cluster                                                                                                                                                                                                                                                                                                                                                                      |
...
| `discover`                                                                | `/organizations/discover` and the cluster's Discover, a text link signed out and a compass icon after the search control signed in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
- `src/components/layout/` — the whole chrome as one folder: `Header.jsx`
  ...
  with search, Discover, theme, language and account signed in and
  Discover, the ticket icon, language, theme and Sign in signed out, the
  search panel),
...
| 3   | Preferences                                                        | signed in through the IdP, or the first `auth` token is `cookie`; drawn on the `cookie` UI backend as well, an in-router link to `/user/profile/preferences`, the one destination that lives in both the column and the menu, because a person changes language, theme and time zone from wherever they stand and the avatar is the one control on every page                                | Link → `{issuer}/user/profile#preferences` (language, theme, time zone, sign-in approval); on the `cookie` UI backend the link is `/user/profile/preferences`. Nothing is edited inline.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| —   | divider                                                            |                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
`customerId` as `ticket.fallbackCustomerId` alone and no `user` or
...
| Cluster: search · Discover · theme · globe · name+avatar signed in; Discover · ticket · globe · theme · Sign in signed out, the brand alone on the left                                    | ✓                                                                           | ✓                                                                                                                                                  | ✓ under `idp`; no Sign in button under `auth: []`                                                                 |                | to come — the shared chrome; the Sign in button hidden on the auth routes, Discover, the ticket icon, language and theme present there                                                                                   |
...
| App-wide search: the module on every page, the "Elsewhere in …" list under the panel, Show all into `/search?q=`, rows in the universal shape                                              | ✓ client-side over the loaded catalogs                                      | ✓ `search` token, `GET /api/search` with the list endpoints' visibility clauses                                                                    | n/a — no collections, no `search`                                                                                 |                | to come — `search` token, `GET /api/search` over organizations and accounts under the list routes' visibility                                                                                                            |
| No bell in the cluster                                                                                                                                                                     | ✓                                                                           | ✓                                                                                                                                                  | ✓                                                                                                                 |                | ✓                                                                                                                                                                                                                        |
| Cluster icon buttons borderless                                                                                                                                                            | ✓                                                                           | ✓                                                                                                                                                  | ✓                                                                                                                 |                | to come — the shared chrome                                                                                                                                                                                              |
| `links.docs` and `links.contact`: Docs and Contact rows of the app section signed in, nothing in the cluster signed out; no search icon signed out                                         | ✓ Contact/Docs                                                              | ✓ Docs                                                                                                                                             | ✓ Docs                                                                                                            |                | to come — `help_url` and `mailto:<support_email>`                                                                                                                                                                        |
...
| Sidebar only from feature exports, brand at its top, rail persisted, foot bare                                                                                                             | ✓ the catalog feature's Catalog group, Home and the Browse tree             | ✓ the Catalog group, then the Account group and the admin entries                                                                                  | to come — the fleet and pools entries                                                                             |                | to come — the Account section for every signed-in person from the profile feature, the operator sections from the identity feature for an admin, none on the auth routes                                                 |
| `footer` token listed                                                                                                                                                                      | ✓ the Worker's status payload                                               | to come                                                                                                                                            | to come                                                                                                           |                | to come — per site, `sites.<id>.ui.footer`                                                                                                                                                                               |
| Footer slots: name · year · version as the repo link · powered-by · health where present                                                                                                   | ✓ repo link + Worker `/health` heart                                        | ✓ repo link + `/api/health` heart                                                                                                                  | ✓ repo link + `/api/health` heart over `database`, `uds` and `events`                                             |                | to come — the changelog link; the heart over `database`, `mail`, `sms` and `signing_keys` while `health` is listed, fed by the core `health` topic                                                                       |
...
| The ticket icon in the signed-out cluster is the ticket link while the app holds a ticket system, the fallback customer id alone, in a new tab; nothing while it holds none                | ✓ `ticket` in `/api/status`                                                 | ✓ `ticket_system` from `/api/config/ticket`                                                                                                        | ✓ `ticket_system` from `/api/config/ticket`                                                                       |                | to come — the auth pages, `ticket.fallbackCustomerId` the site's `customer_id`                                                                                                                                           |
