...
| Theme    | icon button, cycles auto → light → dark, before the language control, the variant alone and never the look: the look, the pack, is chosen on the profile's Preferences page, its select drawing "Follow this site" and one row per pack of `brand.packs`, because the theme-mode control was never asked to carry the variant chooser, that was for the profile menu                                                                                                                                                                                                                                                                                                                                         | same, drawn between search and language; writes through `PATCH /api/user/preferences`                                                                                                                                                                                                                                                                                                                          |
