...
| Theme    | icon button, cycles auto → light → dark, before the language control                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | same, drawn between search and language; writes through `PATCH /api/user/preferences`                                                                                                                                                                                                                                                                                                                          |
