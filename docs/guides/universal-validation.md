...
| `src/features/collections/boxes/utils/forms.js` | the page schemas and label keys of the box, ISO, version, provider and architecture forms, the checksum `custom` rule among them                                                                                                                                                                                                                                                                                                              |
