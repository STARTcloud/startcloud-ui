...
- Parse the path with the mounted collections: `org`, `name`, `version`,
  ...
  record has not answered; a route a loaded tree node matches draws the
  group, then the node path down to it, a node's `matches(pathname)`
  opening the path on a deep link; a reserved route no row matches draws
  the root crumb and the page's title as the second crumb, so the row is
  never empty.
...
| Path                                                          | Role                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `src/features/catalog/`                                       | The shared pages: `HomePage.jsx`, `OrgPage.jsx`, `CollectionPage.jsx`, `ItemPage.jsx`, `VersionPage.jsx`, `ProviderPage.jsx`, `Listing.jsx`, `ItemsTable.jsx`, `ItemCards.jsx`, `ItemFacts.jsx`, `ChecksumCell.jsx`, the `useCatalogSearch` hook, `sidebar.js` (the Catalog group) and `hooks/useCatalogTree.js` (its Browse tree)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `src/utils/routes.js`, `src/components/layout/AppShell.jsx`   | The route parser, `reservedSegments(collections)`, and the crumbs drawn from the route, a sidebar row, a loaded tree node or the page-name crumb context (`src/contexts/CrumbContext.jsx`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
